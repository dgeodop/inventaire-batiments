...
exports.getAllBatOfEtabl = function (req, res) {
	...
	var queryList = 'SELECT bat_dgeo.id_bat_dgeo, bat.id_bat, nom_bat, bat_dgeo.dir FROM bat, bat_dgeo WHERE bat.id_bat=bat_dgeo.id_bat AND id_etabl=$1 AND util=1 ORDER BY id_bat_dgeo';
